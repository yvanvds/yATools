...
${OBJECTDIR}/account/viewAccount.o: account/viewAccount.cpp 
	${MKDIR} -p ${OBJECTDIR}/account
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../libadmintools -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/account/viewAccount.o account/viewAccount.cpp
...
${OBJECTDIR}/auth/passwordService.o: auth/passwordService.cpp 
	${MKDIR} -p ${OBJECTDIR}/auth
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../libadmintools -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/auth/passwordService.o auth/passwordService.cpp
...
${OBJECTDIR}/wisaImport/wisaCommitStudents.o: wisaImport/wisaCommitStudents.cpp 
	${MKDIR} -p ${OBJECTDIR}/wisaImport
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../libadmintools -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wisaImport/wisaCommitStudents.o wisaImport/wisaCommitStudents.cpp
