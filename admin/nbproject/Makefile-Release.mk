...
LDLIBSOPTIONS=-Wl,-rpath,/home/yvan/github/yATools/libadmintools/dist/Release/GNU-Linux -L/home/yvan/github/yATools/libadmintools/dist/Release/GNU-Linux -llibadmintools -lboost_locale -lboost_system -lboost_program_options

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/admin

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/admin: /home/yvan/github/yATools/libadmintools/dist/Release/GNU-Linux/liblibadmintools.so
...
${OBJECTDIR}/_ext/6785788b/password.o: /home/yvan/github/yATools/admin/password.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../libadmintools -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/6785788b/password.o /home/yvan/github/yATools/admin/password.cpp

${OBJECTDIR}/_ext/6785788b/show.o: /home/yvan/github/yATools/admin/show.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/6785788b
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../libadmintools -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/6785788b/show.o /home/yvan/github/yATools/admin/show.cpp
