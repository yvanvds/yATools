...
namespace y {
  namespace data {
    ...
    public:
      ...
      bool createTable(const std::string & tableName, const row & description);
      ...
      bool setRow(const std::string & table, const std::string & condition, const row & values);
      bool addRow(const std::string & table, const row & values);
