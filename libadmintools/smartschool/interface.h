...
@section V3Binding_operations Operations of Binding  "V3Binding"
  ...
  - @ref ns1__isValidUserCredentials
...
@code
  int soap_call_ns1__saveClass(
    ...
    xsd__anyType                        parent,
    xsd__anyType                        untis,
    xsd__anyType                        instituteNumber,
    xsd__anyType                        adminNumber,
    xsd__anyType                        schoolYearDate,
    // output parameters:
    xsd__anyType                       &return_
  );
@endcode
...
int ns1__saveClass(
    std::string                         accesscode,	///< Input parameter
    xsd__anyType                        name,	///< Input parameter
    xsd__anyType                        desc,	///< Input parameter
    xsd__anyType                        code,	///< Input parameter
    xsd__anyType                        parent,	///< Input parameter
    xsd__anyType                        untis,	///< Input parameter
    xsd__anyType                        instituteNumber,	///< Input parameter
    xsd__anyType                        adminNumber,	///< Input parameter
    xsd__anyType                        schoolYearDate,	///< Input parameter
    xsd__anyType                       &return_	///< Output parameter
);
...
Operation details:
Stel het wachtwoord in voor een bepaalde hoofd- of co-account in
<code>
...
<code>
$result = $client->sendMsg('webserviceswachtwoord','admin','Dit is een test', 'Dit
is de body van het testbericht');
</code>
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   ns1__isValidUserCredentials                                              *
 *                                                                            *
\******************************************************************************/


/// Operation "ns1__isValidUserCredentials" of service binding "V3Binding"

/**

Operation details:
Controleer als dit een geldige gebruiker is

  - http://schemas.xmlsoap.org/soap/encoding/ RPC encodingStyle="SOAP"

  - Action: "https://sanctamaria-aarschot.smartschool.be/Webservices/V3#isValidUserCredentials"

  - Addressing input action: "https://sanctamaria-aarschot.smartschool.be/Webservices/V3#isValidUserCredentials"

  - Addressing output action: "https://sanctamaria-aarschot.smartschool.be/Webservices/V3#isValidUserCredentialsResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call_ns1__isValidUserCredentials(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int ns1__isValidUserCredentials(
    struct soap *soap,
    // input parameters:
    std::string                         accesscode,
    std::string                         username,
...
//gsoap ns1  service method-protocol:	isValidUserCredentials SOAP
//gsoap ns1  service method-style:	isValidUserCredentials rpc
//gsoap ns1  service method-encoding:	isValidUserCredentials http://schemas.xmlsoap.org/soap/encoding/
//gsoap ns1  service method-input-action:	isValidUserCredentials https://sanctamaria-aarschot.smartschool.be/Webservices/V3#isValidUserCredentials
//gsoap ns1  service method-output-action:	isValidUserCredentials https://sanctamaria-aarschot.smartschool.be/Webservices/V3#isValidUserCredentialsResponse
int ns1__isValidUserCredentials(
    std::string                         accesscode,	///< Input parameter
    std::string                         username,	///< Input parameter
    std::string                         password,	///< Input parameter
