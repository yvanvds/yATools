/* interface.h
   Generated by wsdl2h 2.8.16 from https://sanctamaria-aarschot.smartschool.be/Webservices/V3?wsdl and typemap.dat
   2015-06-04 18:06:25 GMT
...
@code
  int soap_call_ns1__sendMsg(
    ...
    struct { _XML *__ptr; int __size; } attachments,
    int                                 coaccount,
    // output parameters:
    xsd__anyType                       &return_
  );
...
int ns1__sendMsg(
    ...
    struct { _XML *__ptr; int __size; } attachments,	///< Input parameter
