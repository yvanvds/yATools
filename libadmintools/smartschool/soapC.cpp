...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.16 2015-02-16 15:01:54 GMT")
...
{	switch (p->type)
	...
	case SOAP_TYPE__Struct_1:
		if (p->size < 0)
			SOAP_DELETE((struct _Struct_1*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct _Struct_1*)p->ptr);
		break;
	case SOAP_TYPE_ns1__sendMsgResponse:
		if (p->size < 0)
...
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerToxsd__anyType(soap, &a->return_);
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__isValidUserCredentialsResponse(struct soap *soap, const char *tag, int id, const struct ns1__isValidUserCredentialsResponse *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns1__isValidUserCredentialsResponse), type))
		return soap->error;
	if (a->return_)
	{	if (soap_out_PointerToxsd__anyType(soap, "return", -1, &a->return_, ""))
			return soap->error;
	}
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_return_ && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerToxsd__anyType(soap, "return", &a->return_, "xsd:anyType"))
				{	soap_flag_return_--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns1__sendMsg(struct soap *soap, struct ns1__sendMsg *a)
{
	...
	soap_default__Struct_1(soap, &a->attachments);
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__sendMsg(struct soap *soap, const struct ns1__sendMsg *a)
{
	...
	soap_serialize__Struct_1(soap, &a->attachments);
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__sendMsg(struct soap *soap, const char *tag, int id, const struct ns1__sendMsg *a, const char *type)
{
	...
	if (soap_out_std__string(soap, "senderIdentifier", -1, &a->senderIdentifier, ""))
		return soap->error;
	if (soap_out__Struct_1(soap, "attachments", -1, &a->attachments, ""))
		return soap->error;
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			if (soap_flag_attachments && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in__Struct_1(soap, "attachments", &a->attachments, "xsd:anyType"))
...
SOAP_FMAC1 struct _Struct_1 * SOAP_FMAC2 soap_instantiate__Struct_1(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct _Struct_1);
		if (size)
			*size = sizeof(struct _Struct_1);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct _Struct_1, n);
		if (size)
			*size = n * sizeof(struct _Struct_1);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct _Struct_1*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__Struct_1(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct _Struct_1 %p -> %p\n", q, p));
	*(struct _Struct_1*)p = *(struct _Struct_1*)q;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__setAccountStatus(struct soap *soap, const struct ns1__setAccountStatus *a)
{
	...
	soap_serialize_std__string(soap, &a->accesscode);
	soap_serialize_std__string(soap, &a->userIdentifier);
	soap_serialize_PointerToxsd__anyType(soap, &a->accountStatus);
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__setAccountStatus(struct soap *soap, const char *tag, int id, const struct ns1__setAccountStatus *a, const char *type)
{
	...
	if (soap_out_std__string(soap, "userIdentifier", -1, &a->userIdentifier, ""))
		return soap->error;
	if (soap_out_PointerToxsd__anyType(soap, "accountStatus", -1, &a->accountStatus, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			if (soap_flag_accountStatus && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerToxsd__anyType(soap, "accountStatus", &a->accountStatus, "xsd:anyType"))
...
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerToxsd__anyType(soap, &a->accesscode);
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__getClassList(struct soap *soap, const char *tag, int id, const struct ns1__getClassList *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns1__getClassList), type))
		return soap->error;
	if (soap_out_PointerToxsd__anyType(soap, "accesscode", -1, &a->accesscode, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_accesscode && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerToxsd__anyType(soap, "accesscode", &a->accesscode, "xsd:anyType"))
				{	soap_flag_accesscode--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
...
SOAP_FMAC3 struct ns1__saveClass * SOAP_FMAC4 soap_in_ns1__saveClass(struct soap *soap, const char *tag, struct ns1__saveClass *a, const char *type)
{
	...
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_accesscode > 0 || soap_flag_name > 0 || soap_flag_desc > 0 || soap_flag_code > 0 || soap_flag_parent > 0 || soap_flag_untis > 0 || soap_flag_instituteNumber > 0 || soap_flag_adminNumber > 0))
	{	soap->error = SOAP_OCCURS;
		return NULL;
	}
	return a;
