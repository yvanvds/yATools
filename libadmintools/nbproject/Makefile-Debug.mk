...
${OBJECTDIR}/data/database.o: data/database.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/database.o data/database.cpp

${OBJECTDIR}/data/dateTime.o: data/dateTime.cpp 
	${MKDIR} -p ${OBJECTDIR}/data
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/dateTime.o data/dateTime.cpp

${OBJECTDIR}/data/field.o: data/field.cpp 
	${MKDIR} -p ${OBJECTDIR}/data
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/field.o data/field.cpp

${OBJECTDIR}/data/row.o: data/row.cpp 
	${MKDIR} -p ${OBJECTDIR}/data
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/row.o data/row.cpp

${OBJECTDIR}/data/sqlserver.o: data/sqlserver.cpp 
	${MKDIR} -p ${OBJECTDIR}/data
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/sqlserver.o data/sqlserver.cpp
...
${OBJECTDIR}/gui/stackPageManager.o: gui/stackPageManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/gui
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gui/stackPageManager.o gui/stackPageManager.cpp

${OBJECTDIR}/ldap/account.o: ldap/account.cpp 
	${MKDIR} -p ${OBJECTDIR}/ldap
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ldap/account.o ldap/account.cpp

${OBJECTDIR}/ldap/attributes.o: ldap/attributes.cpp 
	${MKDIR} -p ${OBJECTDIR}/ldap
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ldap/attributes.o ldap/attributes.cpp

${OBJECTDIR}/ldap/data.o: ldap/data.cpp 
	${MKDIR} -p ${OBJECTDIR}/ldap
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ldap/data.o ldap/data.cpp
...
${OBJECTDIR}/smartschool/smartschool.o: smartschool/smartschool.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/smartschool/smartschool.o smartschool/smartschool.cpp

${OBJECTDIR}/smartschool/soapC.o: smartschool/soapC.cpp 
	${MKDIR} -p ${OBJECTDIR}/smartschool
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/smartschool/soapC.o smartschool/soapC.cpp

${OBJECTDIR}/smartschool/soapV3BindingProxy.o: smartschool/soapV3BindingProxy.cpp 
	${MKDIR} -p ${OBJECTDIR}/smartschool
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/smartschool/soapV3BindingProxy.o smartschool/soapV3BindingProxy.cpp

${OBJECTDIR}/system/file.o: system/file.cpp 
	${MKDIR} -p ${OBJECTDIR}/system
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/file.o system/file.cpp

${OBJECTDIR}/system/process.o: system/process.cpp 
	${MKDIR} -p ${OBJECTDIR}/system
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/process.o system/process.cpp

${OBJECTDIR}/system/workDir.o: system/workDir.cpp 
	${MKDIR} -p ${OBJECTDIR}/system
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/workDir.o system/workDir.cpp

${OBJECTDIR}/utils/config.o: utils/config.cpp 
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/config.o utils/config.cpp

${OBJECTDIR}/utils/console.o: utils/console.cpp 
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/console.o utils/console.cpp

${OBJECTDIR}/utils/container.o: utils/container.cpp 
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/container.o utils/container.cpp

${OBJECTDIR}/utils/convert.o: utils/convert.cpp 
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/convert.o utils/convert.cpp
...
${TESTDIR}/data/tests/dataDatabaseTest.o: data/tests/dataDatabaseTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataDatabaseTest.o data/tests/dataDatabaseTest.cpp


${TESTDIR}/data/tests/dataDatabaseTestRun.o: data/tests/dataDatabaseTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataDatabaseTestRun.o data/tests/dataDatabaseTestRun.cpp


${TESTDIR}/data/tests/dataDateTimeTest.o: data/tests/dataDateTimeTest.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataDateTimeTest.o data/tests/dataDateTimeTest.cpp


${TESTDIR}/data/tests/dataDateTimeTestRun.o: data/tests/dataDateTimeTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataDateTimeTestRun.o data/tests/dataDateTimeTestRun.cpp


${TESTDIR}/data/tests/dataFieldTest.o: data/tests/dataFieldTest.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataFieldTest.o data/tests/dataFieldTest.cpp


${TESTDIR}/data/tests/dataFieldTestRun.o: data/tests/dataFieldTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataFieldTestRun.o data/tests/dataFieldTestRun.cpp


${TESTDIR}/data/tests/dataRowTest.o: data/tests/dataRowTest.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataRowTest.o data/tests/dataRowTest.cpp


${TESTDIR}/data/tests/dataRowTestRun.o: data/tests/dataRowTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataRowTestRun.o data/tests/dataRowTestRun.cpp


${TESTDIR}/data/tests/dataServerTest.o: data/tests/dataServerTest.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataServerTest.o data/tests/dataServerTest.cpp


${TESTDIR}/data/tests/dataServerTestRun.o: data/tests/dataServerTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataServerTestRun.o data/tests/dataServerTestRun.cpp


${TESTDIR}/ldap/tests/ldapDataTest.o: ldap/tests/ldapDataTest.cpp 
	${MKDIR} -p ${TESTDIR}/ldap/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/ldap/tests/ldapDataTest.o ldap/tests/ldapDataTest.cpp


${TESTDIR}/ldap/tests/ldapDataTestRun.o: ldap/tests/ldapDataTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/ldap/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/ldap/tests/ldapDataTestRun.o ldap/tests/ldapDataTestRun.cpp


${TESTDIR}/ldap/tests/ldapServerTest.o: ldap/tests/ldapServerTest.cpp 
	${MKDIR} -p ${TESTDIR}/ldap/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/ldap/tests/ldapServerTest.o ldap/tests/ldapServerTest.cpp


${TESTDIR}/ldap/tests/ldapServerTestRun.o: ldap/tests/ldapServerTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/ldap/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/ldap/tests/ldapServerTestRun.o ldap/tests/ldapServerTestRun.cpp


${TESTDIR}/ldap/tests/ldapGroupTest.o: ldap/tests/ldapGroupTest.cpp 
	${MKDIR} -p ${TESTDIR}/ldap/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/ldap/tests/ldapGroupTest.o ldap/tests/ldapGroupTest.cpp


${TESTDIR}/ldap/tests/ldapGroupTestRun.o: ldap/tests/ldapGroupTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/ldap/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/ldap/tests/ldapGroupTestRun.o ldap/tests/ldapGroupTestRun.cpp


${TESTDIR}/ldap/tests/ldpAttributesTest.o: ldap/tests/ldpAttributesTest.cpp 
	${MKDIR} -p ${TESTDIR}/ldap/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/ldap/tests/ldpAttributesTest.o ldap/tests/ldpAttributesTest.cpp


${TESTDIR}/ldap/tests/ldpAttributesTestRun.o: ldap/tests/ldpAttributesTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/ldap/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/ldap/tests/ldpAttributesTestRun.o ldap/tests/ldpAttributesTestRun.cpp


${TESTDIR}/ldap/tests/ldpBaseDataTest.o: ldap/tests/ldpBaseDataTest.cpp 
	${MKDIR} -p ${TESTDIR}/ldap/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/ldap/tests/ldpBaseDataTest.o ldap/tests/ldpBaseDataTest.cpp


${TESTDIR}/ldap/tests/ldpBaseDataTestRun.o: ldap/tests/ldpBaseDataTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/ldap/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/ldap/tests/ldpBaseDataTestRun.o ldap/tests/ldpBaseDataTestRun.cpp


${TESTDIR}/system/tests/sysConfigTest.o: system/tests/sysConfigTest.cpp 
	${MKDIR} -p ${TESTDIR}/system/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/system/tests/sysConfigTest.o system/tests/sysConfigTest.cpp
...
${TESTDIR}/utils/tests/utilsSecurityTest.o: utils/tests/utilsSecurityTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/utils/tests/utilsSecurityTest.o utils/tests/utilsSecurityTest.cpp
...
${OBJECTDIR}/data/database_nomain.o: ${OBJECTDIR}/data/database.o data/database.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/database_nomain.o data/database.cpp;\
	else  \
...
${OBJECTDIR}/data/dateTime_nomain.o: ${OBJECTDIR}/data/dateTime.o data/dateTime.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/dateTime_nomain.o data/dateTime.cpp;\
	else  \
...
${OBJECTDIR}/data/field_nomain.o: ${OBJECTDIR}/data/field.o data/field.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/field_nomain.o data/field.cpp;\
	else  \
...
${OBJECTDIR}/data/row_nomain.o: ${OBJECTDIR}/data/row.o data/row.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/row_nomain.o data/row.cpp;\
	else  \
...
${OBJECTDIR}/data/sqlserver_nomain.o: ${OBJECTDIR}/data/sqlserver.o data/sqlserver.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/sqlserver_nomain.o data/sqlserver.cpp;\
	else  \
...
${OBJECTDIR}/gui/stackPageManager_nomain.o: ${OBJECTDIR}/gui/stackPageManager.o gui/stackPageManager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gui/stackPageManager_nomain.o gui/stackPageManager.cpp;\
	else  \
...
${OBJECTDIR}/ldap/account_nomain.o: ${OBJECTDIR}/ldap/account.o ldap/account.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ldap/account_nomain.o ldap/account.cpp;\
	else  \
...
${OBJECTDIR}/ldap/attributes_nomain.o: ${OBJECTDIR}/ldap/attributes.o ldap/attributes.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ldap/attributes_nomain.o ldap/attributes.cpp;\
	else  \
...
${OBJECTDIR}/ldap/data_nomain.o: ${OBJECTDIR}/ldap/data.o ldap/data.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ldap/data_nomain.o ldap/data.cpp;\
	else  \
...
${OBJECTDIR}/ldap/dataset_nomain.o: ${OBJECTDIR}/ldap/dataset.o ldap/dataset.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ldap/dataset_nomain.o ldap/dataset.cpp;\
	else  \
...
${OBJECTDIR}/ldap/server_nomain.o: ${OBJECTDIR}/ldap/server.o ldap/server.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ldap/server_nomain.o ldap/server.cpp;\
	else  \
...
${OBJECTDIR}/smartschool/smartschool_nomain.o: ${OBJECTDIR}/smartschool/smartschool.o smartschool/smartschool.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/smartschool/smartschool_nomain.o smartschool/smartschool.cpp;\
	else  \
...
${OBJECTDIR}/smartschool/soapC_nomain.o: ${OBJECTDIR}/smartschool/soapC.o smartschool/soapC.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/smartschool/soapC_nomain.o smartschool/soapC.cpp;\
	else  \
...
${OBJECTDIR}/smartschool/soapV3BindingProxy_nomain.o: ${OBJECTDIR}/smartschool/soapV3BindingProxy.o smartschool/soapV3BindingProxy.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/smartschool/soapV3BindingProxy_nomain.o smartschool/soapV3BindingProxy.cpp;\
	else  \
...
${OBJECTDIR}/system/file_nomain.o: ${OBJECTDIR}/system/file.o system/file.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/file_nomain.o system/file.cpp;\
	else  \
...
${OBJECTDIR}/system/process_nomain.o: ${OBJECTDIR}/system/process.o system/process.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/process_nomain.o system/process.cpp;\
	else  \
...
${OBJECTDIR}/system/workDir_nomain.o: ${OBJECTDIR}/system/workDir.o system/workDir.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/workDir_nomain.o system/workDir.cpp;\
	else  \
...
${OBJECTDIR}/utils/config_nomain.o: ${OBJECTDIR}/utils/config.o utils/config.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/config_nomain.o utils/config.cpp;\
	else  \
...
${OBJECTDIR}/utils/console_nomain.o: ${OBJECTDIR}/utils/console.o utils/console.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/console_nomain.o utils/console.cpp;\
	else  \
...
${OBJECTDIR}/utils/container_nomain.o: ${OBJECTDIR}/utils/container.o utils/container.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/container_nomain.o utils/container.cpp;\
	else  \
...
${OBJECTDIR}/utils/convert_nomain.o: ${OBJECTDIR}/utils/convert.o utils/convert.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/convert_nomain.o utils/convert.cpp;\
	else  \
...
${OBJECTDIR}/utils/log_nomain.o: ${OBJECTDIR}/utils/log.o utils/log.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/log_nomain.o utils/log.cpp;\
	else  \
