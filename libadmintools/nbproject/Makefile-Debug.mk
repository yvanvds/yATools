...
${OBJECTDIR}/data/sqlserver.o: data/sqlserver.cpp 
	${MKDIR} -p ${OBJECTDIR}/data
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DDEBUG -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/sqlserver.o data/sqlserver.cpp
...
${OBJECTDIR}/gui/passwordDialog.o: gui/passwordDialog.cpp 
	${MKDIR} -p ${OBJECTDIR}/gui
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DDEBUG -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gui/passwordDialog.o gui/passwordDialog.cpp

${OBJECTDIR}/gui/session.o: gui/session.cpp 
	${MKDIR} -p ${OBJECTDIR}/gui
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DDEBUG -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gui/session.o gui/session.cpp
...
${TESTDIR}/data/tests/dataServerTest.o: data/tests/dataServerTest.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DDEBUG -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataServerTest.o data/tests/dataServerTest.cpp


${TESTDIR}/data/tests/dataServerTestRun.o: data/tests/dataServerTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DDEBUG -I. -I../dependencies/boost_process -I/usr/include -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataServerTestRun.o data/tests/dataServerTestRun.cpp
...
${OBJECTDIR}/data/sqlserver_nomain.o: ${OBJECTDIR}/data/sqlserver.o data/sqlserver.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -DDEBUG -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/sqlserver_nomain.o data/sqlserver.cpp;\
	else  \
...
${OBJECTDIR}/gui/passwordDialog_nomain.o: ${OBJECTDIR}/gui/passwordDialog.o gui/passwordDialog.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -DDEBUG -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gui/passwordDialog_nomain.o gui/passwordDialog.cpp;\
	else  \
...
${OBJECTDIR}/gui/session_nomain.o: ${OBJECTDIR}/gui/session.o gui/session.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -DDEBUG -I. -I../dependencies/boost_process -I/usr/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gui/session_nomain.o gui/session.cpp;\
	else  \
