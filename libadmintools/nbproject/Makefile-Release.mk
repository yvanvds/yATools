...
${OBJECTDIR}/data/database.o: data/database.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/database.o data/database.cpp

${OBJECTDIR}/data/field.o: data/field.cpp 
	${MKDIR} -p ${OBJECTDIR}/data
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/field.o data/field.cpp

${OBJECTDIR}/data/row.o: data/row.cpp 
	${MKDIR} -p ${OBJECTDIR}/data
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/row.o data/row.cpp
...
${OBJECTDIR}/utils/convert.o: utils/convert.cpp 
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/convert.o utils/convert.cpp
...
${OBJECTDIR}/utils/security.o: utils/security.cpp 
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/security.o utils/security.cpp
...
${TESTDIR}/data/tests/dataDatabaseTest.o: data/tests/dataDatabaseTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataDatabaseTest.o data/tests/dataDatabaseTest.cpp


${TESTDIR}/data/tests/dataDatabaseTestRun.o: data/tests/dataDatabaseTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataDatabaseTestRun.o data/tests/dataDatabaseTestRun.cpp


${TESTDIR}/data/tests/dataFieldTest.o: data/tests/dataFieldTest.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataFieldTest.o data/tests/dataFieldTest.cpp


${TESTDIR}/data/tests/dataFieldTestRun.o: data/tests/dataFieldTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataFieldTestRun.o data/tests/dataFieldTestRun.cpp


${TESTDIR}/data/tests/dataRowTest.o: data/tests/dataRowTest.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataRowTest.o data/tests/dataRowTest.cpp


${TESTDIR}/data/tests/dataRowTestRun.o: data/tests/dataRowTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataRowTestRun.o data/tests/dataRowTestRun.cpp


${TESTDIR}/data/tests/dataServerTest.o: data/tests/dataServerTest.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataServerTest.o data/tests/dataServerTest.cpp


${TESTDIR}/data/tests/dataServerTestRun.o: data/tests/dataServerTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/data/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/data/tests/dataServerTestRun.o data/tests/dataServerTestRun.cpp


${TESTDIR}/ldap/tests/ldapDataTest.o: ldap/tests/ldapDataTest.cpp 
	${MKDIR} -p ${TESTDIR}/ldap/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/ldap/tests/ldapDataTest.o ldap/tests/ldapDataTest.cpp


${TESTDIR}/ldap/tests/ldapDataTestRun.o: ldap/tests/ldapDataTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/ldap/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/ldap/tests/ldapDataTestRun.o ldap/tests/ldapDataTestRun.cpp
...
${TESTDIR}/utils/tests/utilsSecurityTest.o: utils/tests/utilsSecurityTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/utils/tests/utilsSecurityTest.o utils/tests/utilsSecurityTest.cpp


${TESTDIR}/utils/tests/utilsSecurityTestRun.o: utils/tests/utilsSecurityTestRun.cpp 
	${MKDIR} -p ${TESTDIR}/utils/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/utils/tests/utilsSecurityTestRun.o utils/tests/utilsSecurityTestRun.cpp
...
${OBJECTDIR}/data/database_nomain.o: ${OBJECTDIR}/data/database.o data/database.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/database_nomain.o data/database.cpp;\
	else  \
...
${OBJECTDIR}/data/field_nomain.o: ${OBJECTDIR}/data/field.o data/field.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/field_nomain.o data/field.cpp;\
	else  \
...
${OBJECTDIR}/data/row_nomain.o: ${OBJECTDIR}/data/row.o data/row.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/data/row_nomain.o data/row.cpp;\
	else  \
...
${OBJECTDIR}/utils/convert_nomain.o: ${OBJECTDIR}/utils/convert.o utils/convert.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/convert_nomain.o utils/convert.cpp;\
	else  \
...
${OBJECTDIR}/utils/security_nomain.o: ${OBJECTDIR}/utils/security.o utils/security.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/security_nomain.o utils/security.cpp;\
	else  \
